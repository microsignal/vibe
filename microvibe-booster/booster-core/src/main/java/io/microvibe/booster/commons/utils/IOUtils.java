...
public class IOUtils extends org.apache.commons.io.IOUtils {
	...
	public static long copyLarge(final Reader input, final Writer output) throws IOException {
		return IOUtils.copyLarge(input, output, new char[DEFAULT_BUFFER_SIZE]);
	}
	...
	public static InputStream getInputStream(final String path) throws FileNotFoundException {
		try {
			...
			return IOUtils.getInputStream(path, clazz);
		} catch (ClassNotFoundException e) {
			return IOUtils.getInputStream(path, IOUtils.class);
		}
	}
