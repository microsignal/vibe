...
<div id="main">
	...
	<form name=alipayment action="/api/pay/alipay/web/pay.do" method="post" target="_blank">
	...
	<form name=tradequery action="/api/pay/alipay/web/trade/query.do" method=post
		target="_blank">
	...
	<form name=traderefund action="/api/pay/alipay/web/trade/refund.do" method=post
		target="_blank">
		<div id="body3" class="tab-content" name="divcontent">
			<dl class="content">
				...
				<dt>支付宝交易号 ：</dt>
				<dd>
					<input id="WIDTRtrade_no" name="trade_no"/>
				</dd>
				<hr class="one_line">
				<dt>退款金额 ：</dt>
				<dd>
					<input id="WIDTRrefund_amount" name="refund_amount"/>
				</dd>
				<hr class="one_line">
				<dt>退款原因 ：</dt>
				<dd>
					<input id="WIDTRrefund_reason" name="refund_reason"/>
				</dd>
				<hr class="one_line">
				<dt>退款请求号 ：</dt>
				<dd>
					<input id="WIDTRout_request_no" name="out_request_no"/>
				</dd>
				<hr class="one_line">
				<dt></dt>
				<dd id="btn-dd">
	...
	<form name=traderefundquery
		action="/api/pay/alipay/web/trade/refund/query.do" method=post
		target="_blank">
	...
	<form name=tradeclose action="/api/pay/alipay/web/trade/close.do" method=post
		target="_blank">
