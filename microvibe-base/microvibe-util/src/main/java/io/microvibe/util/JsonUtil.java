...
public class JsonUtil {
    ...
    public static List<?> toList(Class<?> type, String json) {
        return toList(type, null, json);
    }

    public static List<?> toList(Class<?> type, String field, String json) {
        List<?> rs = null;
        JsonConverter jsonConverter = JsonConverter.getInstance();
        if (field == null) {
    ...
    public static List<?> toMapList(String field, String json) {
